...
| وثائق | `VIOLATIONS_DEPLOYMENT_GUIDE_AR.md`، `VIOLATIONS_IMPLEMENTATION_REPORT_AR.md`، `REPAIR_AUDIT_REPORT_AR.md` |
...
ابدأ بملف [دليل النشر](VIOLATIONS_DEPLOYMENT_GUIDE_AR.md)، ثم نفذ اختبارات القبول قبل إدخال بيانات تشغيلية.
