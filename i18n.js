...
Object.assign(translations.ar, {
    ...
    'Vehicle Unassignment': 'فك عهدة مركبة',
    'Vehicle Reassignment': 'نقل عهدة',
    'Violation Discussion': 'مناقشة مخالفة',
    ...
    'Messages': 'الرسائل',
    'Review assignment, custody, violation, and message notices.': 'تابع تنبيهات المركبات والمخالفات والرسائل.',
    ...
    'Notification acknowledged.': 'تم تأكيد الاطلاع على الإشعار.',
    'Unable to acknowledge this notification. Please try again.': 'تعذر تأكيد الاطلاع على الإشعار. يرجى إعادة المحاولة.',
    'Contact Management': 'مراسلة الإدارة',
    'View Vehicle': 'عرض المركبة',
    ...
    'Messages may be viewed and answered by all authorised administrators.': 'يمكن للإدارة الاطلاع على الرسائل والرد عليها.',
    'Management can view and reply to these messages.': 'يمكن للإدارة الاطلاع على هذه الرسائل والرد عليها.',
    'Your message will be sent directly to management.': 'ستُرسل رسالتك مباشرة إلى الإدارة.',
    'Send messages directly to management.': 'أرسل رسالتك مباشرة إلى الإدارة.',
    'Message': 'الرسالة',
    ...
    'Administrators can view and reply to all internal messages.': 'يمكن للمديرين قراءة جميع الرسائل والرد عليها.',
    'Send messages only to management. All authorised administrators may review and reply.': 'ترسل الرسائل إلى الإدارة فقط. ويمكن لجميع المديرين الاطلاع عليها والرد عليها.',
    'Sent': 'مرسلة',
    'To': 'إلى',
    'Related to': 'مرتبطة بـ',
    'GENERAL': 'عام',
    'ASSIGNMENT': 'تعيين مركبة',
    'UNLINK_APPROVED': 'انتهاء العهدة',
    'REASSIGNED': 'نقل المركبة',
    'VIOLATION': 'مخالفة',
    'General': 'عام',
    'Vehicle Assignment': 'تعيين مركبة',
